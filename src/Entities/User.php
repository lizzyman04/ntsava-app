 ...
 * @Cycle\Table(indexes={
 *     @Cycle\Index(columns={"email"}, unique=true),
 *     @Cycle\Index(columns={"username"}, unique=true),
 *     @Cycle\Index(columns={"uuid"}, unique=true),
 *     @Cycle\Index(columns={"status"})
 * })
 */
class User
{
    ...
    /**
     * @Cycle\Column(type="string", length=50, nullable=false)
     */
    ...
    /**
     * @Cycle\Column(type="integer", name="plan_id", nullable=false)
     */
    private int $planId;

    /**
     * @Cycle\Column(type="bigInteger", name="storage_limit_bytes", nullable=false)
     */
    private int $storageLimitBytes;

    /**
     * @Cycle\Column(type="bigInteger", name="storage_used_bytes", nullable=false)
     */
    private int $storageUsedBytes = 0;

    /**
     * @Cycle\Column(type="bigInteger", name="bandwidth_limit_bytes", nullable=false)
     */
    private int $bandwidthLimitBytes;

    /**
     * @Cycle\Column(type="bigInteger", name="bandwidth_used_bytes", nullable=false)
     */
    private int $bandwidthUsedBytes = 0;

    /**
     * @Cycle\Column(type="integer", name="bandwidth_reset_month", nullable=false)
     */
