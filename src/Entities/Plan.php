...
/**
 * @Cycle\Entity(table="plans")
 * @Cycle\Table(indexes={
 *     @Cycle\Index(columns={"slug"}, unique=true),
 *     @Cycle\Index(columns={"is_active"}),
...
class Plan
{
    ...
    /**
     * @Cycle\Column(type="boolean", name="is_active", nullable=false)
     */
    private bool $isActive = true;

    /**
     * @Cycle\Column(type="integer", name="sort_order", nullable=false)
     */
