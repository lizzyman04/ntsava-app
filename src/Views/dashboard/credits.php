        ...
        <div class="glass-card p-6">
            ...
            <div class="grid md:grid-cols-3 gap-4">
                <?php foreach ($plans as $plan): ?>
                    ...
                    <div class="border border-gray-200 rounded-xl p-4 text-center hover:shadow-lg transition">
                        ...
                        <?php else: ?>
                            <a href="mailto:contact@ntsava.omeu.space"
                    ...
                    <?php foreach ($transactions as $transaction): ?>
                        ...
                        <tr class="border-b border-gray-100 hover:bg-gray-50 transition">
                            ...
                            <td class="py-3 capitalize">
                                <span
                                    class="px-2 py-1 text-xs rounded-full bg-gray-100"><?= str_replace('_', ' ', $transaction->getType()) ?></span>
                            </td>
                            ...
                            <td class="py-3 text-gray-600"><?= $transaction->getCurrency() ?>
