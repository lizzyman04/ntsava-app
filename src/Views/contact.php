        ...
        <div class="grid lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div class="space-y-6">
                <div class="glass-card p-6 text-center">
                    ...
                    <p class="text-sm text-gray-500">support@ntsava.space</p>
                    <p class="text-sm text-gray-500">sales@ntsava.space</p>
                </div>
                <div class="glass-card p-6 text-center">
                    <div class="w-12 h-12 rounded-full bg-primary-100 flex items-center justify-center mx-auto mb-3">
                ...
                <div class="glass-card p-8">
                    ...
                    <form id="contactForm" method="POST" action="/contact">
                        ...
                        <div class="grid md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <select name="subject" class="input-field" required>
                                    ...
                                    <option value="enterprise" <?= $plan === 'business' ? 'selected' : '' ?>>Enterprise</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="plan" class="input-field">
                                    ...
                                    <option value="plus" <?= $plan === 'plus' ? 'selected' : '' ?>>Plus ($10/mo)</option>
                                    <option value="pro" <?= $plan === 'pro' ? 'selected' : '' ?>>Pro ($49/mo)</option>
                                    <option value="business" <?= $plan === 'business' ? 'selected' : '' ?>>Business (Custom)</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="message" rows="5" class="input-field" required placeholder="Tell us how we can help..."></textarea>
                        </div>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <div class="glass-card p-6">
                ...
                <p class="text-gray-500 text-sm">You can upgrade directly from your dashboard using credits. Contact us for add credit or enterprise plans.</p>
            </div>
            <div class="glass-card p-6">
                <h3 class="font-semibold text-gray-900 mb-2">What payment methods do you accept?</h3>
                <p class="text-gray-500 text-sm">We accept credit cards, PayPal, and bank transfers for enterprise customers.</p>
            </div>
            <div class="glass-card p-6">
                <h3 class="font-semibold text-gray-900 mb-2">Is there a free plan?</h3>
                <p class="text-gray-500 text-sm">Yes! Our free plan includes 1GB storage and 20GB bandwidth monthly.</p>
            </div>
            <div class="glass-card p-6">
                <h3 class="font-semibold text-gray-900 mb-2">Do you offer custom domains?</h3>
                <p class="text-gray-500 text-sm">Yes, custom domains are available on Plus and higher plans.</p>
            </div>
        </div>
    </div>
</section>
